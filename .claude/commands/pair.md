...
```bash
npx designlang@12.21.0 pair $ARGUMENTS
```
...
```
npx designlang@12.21.0 pair stripe.com linear.app                 # default split
npx designlang@12.21.0 pair stripe.com linear.app --type-from a   # Stripe everything except components/voice from Linear
npx designlang@12.21.0 pair vercel.com apple.com --brand          # fused identity as a hand-off brand book
```
